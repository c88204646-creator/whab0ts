...
import { Plus, ChevronLeft, ChevronRight, X, Trash2, AlertCircle, CheckCircle2, Calendar as CalendarIcon, Clock, XCircle, AlertOctagon, Inbox, Phone, User, Copy, Share2, Settings, Zap, AlertTriangle, Search, Eye, Edit3, TrendingUp, Globe, ExternalLink, Briefcase, Building, Mail, MapPin, FileText, Tag, MessageCircle } from "lucide-react";
...
export default function CalendarPage() {
  ...
  const handleCreateEvent = async () => {
    ...
    if (clientMode === "create" && contactName.trim()) {
      ...
      // Validate email if provided when creating new client
