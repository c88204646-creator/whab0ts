                  ...
                  <CardContent className="p-0 flex flex-col h-full">
                    {availableSlots.length === 0 ? (
                      ...
                      <div className="flex flex-col h-full">
                        {/* Header Section */}
                        <div className="px-4 py-3.5 border-b border-border/30 flex-shrink-0 bg-gradient-to-r from-primary/5 to-transparent">
                          <p className="text-xs font-semibold text-foreground flex items-center gap-2.5">
                            ...
                            {availableSlots.map((slot, idx) => {
                              ...
                              return (
                                <button
                                  ...
                                  className={`relative group rounded-lg px-2 py-2.5 text-xs font-semibold transition-all duration-200 flex flex-col items-center justify-center ${
                                    selectedTime === slot
                                      ? "bg-primary/90 text-primary-foreground border-2 border-primary shadow-md hover-elevate"
                                      : "bg-card border border-border/40 text-foreground hover:bg-primary/5 hover:border-primary/40 hover-elevate"
                                  }`}
                                  data-testid={`button-time-${slot}`}
                                >
                                  <span className="text-sm font-bold leading-tight">{slot}</span>
                                  {isPopular && (
                                    <div className="absolute -top-2 -right-2 w-4 h-4 rounded-full bg-gradient-to-br from-orange-400 to-orange-500 flex items-center justify-center border-2 border-background shadow-md flex-shrink-0 animate-pulse">
                        ...
                        {selectedTime && (
                          <div className="px-4 py-3.5 border-t border-border/30 flex-shrink-0 bg-primary/5 space-y-3">
                            <div className="p-3 rounded-lg bg-primary/10 border border-primary/20 space-y-1">
                              <p className="text-xs text-muted-foreground font-medium">Horario seleccionado</p>
