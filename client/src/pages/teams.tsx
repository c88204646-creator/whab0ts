                ...
                <Card key={member.id} className={`group relative hover-elevate active-elevate-2 transition-all duration-300 border border-border/40 flex flex-col overflow-hidden bg-gradient-to-br from-card to-card/80 backdrop-blur-sm`}>
                  ...
                  {!isOwner && (
                    <>
                      ...
                      <div className="flex items-center gap-0.5 px-1.5 py-1.5 bg-muted/10 justify-center">
                        <Button
                          size="icon"
                          variant="outline"
                        ...
                        <Button
                          ...
                          className="h-6 w-6 hover-elevate border-destructive/30 text-destructive hover:bg-destructive/5"
