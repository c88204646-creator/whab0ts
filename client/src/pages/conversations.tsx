...
export default function ConversationsPage() {
  ...
  return (
    <div className="flex flex-col h-full bg-background">
      <div className="flex-shrink-0 border-b border-border bg-gradient-to-br from-primary/10 via-primary/5 to-transparent sticky top-0 z-10 px-6 py-3.5 shadow-sm">
        <div className="max-w-[1800px] mx-auto">
          <div className="flex items-center justify-between gap-3">
            <div className="flex items-center gap-2.5 min-w-0">
              ...
              <div className="min-w-0">
                ...
                <p className="text-xs text-muted-foreground/80 truncate">Gestiona tus chats de WhatsApp en tiempo real</p>
              </div>
            </div>
            ...
            {accounts.length > 0 && (
              <div className="flex items-center gap-2 flex-shrink-0">
                <Select value={activeAccountId || ""} onValueChange={setActiveAccountId}>
                  <SelectTrigger className="w-48 h-8 text-xs bg-white/50 dark:bg-muted/30 border border-primary/20 rounded-lg hover:border-primary/40 transition-all font-medium" data-testid="select-account">
          ...
          {activeAccountId && (
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-2 w-full mt-3">
              <motion.div
                initial={{ opacity: 0, y: 8 }}
                animate={{ opacity: 1, y: 0 }}
                className="bg-gradient-to-br from-blue-500/15 to-blue-500/5 rounded-md px-2.5 py-2 border border-blue-500/40 hover:border-blue-500/60 hover:shadow-md transition-all"
              >
                <div className="flex items-center gap-2 w-full min-w-0">
                  <div className="w-8 h-8 rounded-md bg-blue-500/25 flex items-center justify-center flex-shrink-0 shadow-sm">
                    <MessageCircle className="w-4 h-4 text-blue-600" />
                  </div>
                  <div className="flex-1 min-w-0 overflow-hidden">
                    <p className="text-sm font-bold text-blue-600 truncate">{totalConversations}</p>
                    <p className="text-[10px] text-blue-600/70 font-medium leading-tight truncate">Conversaciones</p>
                  </div>
                </div>
              </motion.div>
              ...
              <motion.div
                ...
                className="bg-gradient-to-br from-orange-500/15 to-orange-500/5 rounded-md px-2.5 py-2 border border-orange-500/40 hover:border-orange-500/60 hover:shadow-md transition-all"
              >
                <div className="flex items-center gap-2 w-full min-w-0">
                  <div className="w-8 h-8 rounded-md bg-orange-500/25 flex items-center justify-center flex-shrink-0 shadow-sm">
                    <Bell className="w-4 h-4 text-orange-600" />
                  </div>
                  <div className="flex-1 min-w-0 overflow-hidden">
                    <p className="text-sm font-bold text-orange-600 truncate">{unreadCount}</p>
                    <p className="text-[10px] text-orange-600/70 font-medium leading-tight truncate">Sin leer</p>
                  </div>
                </div>
              </motion.div>
              ...
              <motion.div
                ...
                className="bg-gradient-to-br from-emerald-500/15 to-emerald-500/5 rounded-md px-2.5 py-2 border border-emerald-500/40 hover:border-emerald-500/60 hover:shadow-md transition-all"
              >
                <div className="flex items-center gap-2 w-full min-w-0">
                  <div className="w-8 h-8 rounded-md bg-emerald-500/25 flex items-center justify-center flex-shrink-0 shadow-sm">
                    <TrendingUp className="w-4 h-4 text-emerald-600" />
                  </div>
                  <div className="flex-1 min-w-0 overflow-hidden">
                    <p className="text-sm font-bold text-emerald-600 truncate">{recentCount}</p>
                    <p className="text-[10px] text-emerald-600/70 font-medium leading-tight truncate">Recientes</p>
                  </div>
                </div>
              </motion.div>
              ...
              <motion.div
                ...
                className="bg-gradient-to-br from-red-500/15 to-red-500/5 rounded-md px-2.5 py-2 border border-red-500/40 hover:border-red-500/60 hover:shadow-md transition-all"
              >
                <div className="flex items-center gap-2 w-full min-w-0">
                  <div className="w-8 h-8 rounded-md bg-red-500/25 flex items-center justify-center flex-shrink-0 shadow-sm">
                    <AlertCircle className="w-4 h-4 text-red-600" />
                  </div>
                  <div className="flex-1 min-w-0 overflow-hidden">
                    <p className="text-sm font-bold text-red-600 truncate">{urgentCount}</p>
                    <p className="text-[10px] text-red-600/70 font-medium leading-tight truncate">Urgentes</p>
                  </div>
                </div>
              </motion.div>
            </div>
