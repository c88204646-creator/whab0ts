...
const COLORS = ['hsl(var(--primary))', 'hsl(var(--accent))', 'hsl(var(--destructive))', '#8b5cf6', '#06b6d4', '#f59e0b', '#ec4899'];
        ...
        <div className="px-4 py-8">
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
              <StatCard label="Respuestas" value={responses.length} icon={MessageSquare} />
                            ...
                            <ResponsiveContainer width="100%" height={250}>
                              <BarChart
                                data={options.map(option => ({
                                  option: option.substring(0, 15),
                                  count: getAnswerCount(question.id, option),
                                  percentage: ((getAnswerCount(question.id, option) / responseCount) * 100).toFixed(1),
                                }))}
                              >
                                <CartesianGrid strokeDasharray="3 3" stroke="var(--border)" />
                                <XAxis dataKey="option" stroke="var(--muted-foreground)" />
