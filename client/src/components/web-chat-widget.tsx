...
import { ChevronUp, Send, X, MessageCircle, Calendar, Phone, Mail, User } from "lucide-react";
      ...
      >
        ...
        >
          <div className="min-w-0 flex items-center gap-2">
            ...
            <div>
              <h3 className="font-bold text-sm leading-tight">Ventas</h3>
              {!isMinimized && (
        ...
        {!isMinimized && (
          <>
            <div className="flex-1 overflow-y-auto p-4 space-y-3 bg-gradient-to-b from-muted/30 to-background flex flex-col">
              {/* Welcome Step */}
              {currentStep === "welcome" && (
            ...
            {/* Input Footer */}
            {currentStep === "welcome" && (
              <div className="border-t border-border/20 px-4 py-3 bg-background flex-shrink-0"></div>
            )}
          </>
        )}
      </div>
...
// Add Clock icon import at top (using system icon)
