...
import { MessageSquare, Link as LinkIcon, Bot, Settings, LogOut, MessageCircle, ChevronDown, BarChart3, Users, Target, Facebook, Calendar, Sparkles, ShoppingBag, Globe, Zap, Ticket } from "lucide-react";
import {
  Sidebar,
  SidebarContent,
  SidebarGroup,
...
export function AppSidebar({ user, onLogout }: AppSidebarProps) {
  ...
  const isRafflesActive = rafflesMenuItems.some((item) => location === item.url);
